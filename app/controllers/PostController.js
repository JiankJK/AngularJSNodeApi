...
app.controller('PostController', function ($scope, $http, $location) {
  ...
  function getResultsPage() {
    $http({
      url: URL + 'vehiculo/'+$scope.userIdLocal,
      method: 'GET'
    }).then(function (res) {
      $scope.data = res.data;
      console.log(res);
  ...
  $scope.postdata = function () {
    ...
    $http.post("http://localhost:9000/api/vehiculo", JSON.stringify(data))
  ...
  */
  ...
  $scope.saveData = function () {
    ...
    console.log(dataE);
    $http.put("http://localhost:9000/api/vehiculo/"+this.idVehiculoE, JSON.stringify(dataE))
      .then(function (response) {
        console.log(response);
  ...
  $scope.delete = function(id){
    console.log(id);
    $http.delete("http://localhost/angularJsCrud/api/pacientes?id=" + id)
      .then(function(response){
        console.log(response);
        if(response.data){
